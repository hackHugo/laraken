...
//>> Properties
    ...
    */
    ...
    /**
    * A boolean value indicating if the "data" tab should be displayed or a collection of tools that will be shown in the "data" tab.The available tools are: sort; filter or validation.
    * @param boolean|array $value
    * @return \Kendo\UI\SpreadsheetToolbar
    */
